...
const Card: React.FC<CardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`bg-gray_shade_1 py-[2.3rem] rounded-t-[1.6rem] text-[1.6rem] font-bold text-center relative mb-[1.5rem] md:mb-[2rem] px-[2rem] md:text-[1.8rem] ${headerStyles}`}
      >
