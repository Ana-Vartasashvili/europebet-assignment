...
const Layout = ({ children }: Children) => {
  return (
    ...
    >
      ...
      <div className='h-full bg-background_black_shade_1 max-w-[94rem] medium:h-[97%] medium:fixed medium:bottom-0 medium:rounded-t-[2.5rem] overflow-y-auto scrollbar-hide pb-[22rem] relative'>
        <LayoutHeader>{children}</LayoutHeader>

        <div className='bg-background_black_shade_2 py-[1.4rem] w-full fixed bottom-0 flex justify-center items-center border-t-[0.35rem] border-t-main_orange max-w-[94rem]'>
